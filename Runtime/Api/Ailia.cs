...
public class Ailia
{
    ...
    */
    [DllImport(LIBRARY_NAME)]
    public static extern int ailiaCopyBlobData(IntPtr dst_net, UInt32 dst_blob_idx, IntPtr src_net, UInt32 src_blob_idx);
    ...
    * AILIA_MEMORY_REDUCE_INTERSTAGE and AILIA_MEMORY_REUSE_INTERSTAGE can be used together. */
    public const Int32 AILIA_MEMORY_REDUCE_CONSTANT_WITH_FILE_MAPPED                       = (16);
